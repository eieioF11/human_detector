...
# from tdmpc2_model_base_v2_hdyn_no_latent import TDMPC2, TDMPC_TYPE
...
@hydra.main(config_name="hdyn_train_model_parameter.yaml", config_path=cfg_path)
def train(cfg: dict):
    """
    ...
    while _step <= cfg.steps:
        ...
        if done:
            ...
            obs = env.reset(render=cfg.train_render, state=random_state(
                x_limit=[10.0, 20.0], y_limit=[5.0, 25.0]), collision_off=True)
