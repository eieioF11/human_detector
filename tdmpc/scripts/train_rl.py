...
from env.math_utils import make_state, compute_spl
...
# from tdmpc2_model_base_rl_rnn import TDMPC2, TDMPC_TYPE
# from tdmpc2_model_base_rl_reg import TDMPC2, TDMPC_TYPE
# from tdmpc2_model_base_rl_no_latent import TDMPC2, TDMPC_TYPE


# from tdmpc2_model_base_rl import TDMPC2, TDMPC_TYPE
from tdmpc2_model_base_v2_rl import TDMPC2, TDMPC_TYPE
# from tdmpc2_model_base_shift_rl import TDMPC2, TDMPC_TYPE
# from tdmpc2_model_base_v2_rl_no_latent import TDMPC2, TDMPC_TYPE
...
@hydra.main(config_name="rl_model_parameter.yaml", config_path=cfg_path)
def train(cfg: dict):
    """
    ...
    # env = make_nav_env(cfg, env_cfg, use_dt_sep=True)
