...
class WorldModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.latent_separate:
            ...
            self._latent_h_e = self._latent_h_s + self.cfg.h_obs_shape["state"][0]
            self.cfg.latent_dim = self.cfg.latent_r_dim + self.cfg.h_obs_shape["state"][0]
    ...
    def encode(self, obs):
        ...
        if self.cfg.latent_separate:
            ...
            return torch.cat([z_r, h_obs], dim=-1)
